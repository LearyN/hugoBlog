...
Still at Test Account level
Apply for Basic Access
Query returns empty
Used MCC ID to query data
Use sub-account ID instead
RESOURCE_EXHAUSTED
Daily quota of 15,000 exhausted
...
Fix
403 Forbidden
SA doesn't have site permission
Add SA email in GSC settings
Site format mismatch
sc-domain:example.com vs https://example.com/
Use the exact format shown in GSC
Data delayed 2-3 days
Normal Google behavior
Not a config issue
